...
export default function PricingSection() {
  ...
  function getButtonLabel(pkgKey: string) {
    ...
    switch (pkgKey) {
      ...
      case 'chatbotStarter': return buttons.getPremiumChatbot;
      case 'chatbotPremium': return buttons.getGrowthChatbot;
      case 'chatbotElite': return buttons.getEliteChatbot;
  ...
  const packageOrder = [
    ...
    'chatbotStarter', 'chatbotPremium', 'chatbotElite',
