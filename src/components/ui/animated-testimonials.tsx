...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-20 font-sans antialiased md:max-w-5xl md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          >
            ...
            <motion.p className="mt-8 font-copy text-sm text-gray-500 dark:text-neutral-300">
